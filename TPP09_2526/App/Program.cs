...
public static class Program
{
    ...
    static void Consulta1()
    {
        ...
        var consulta1 = modelo.Peliculas.Where(p => p.Director.StartsWith("C"));
        Show(consulta1);
    }
    ...
    static void Consulta2()
    {
        ...
        var consulta2 = modelo.Peliculas.Where(p => p.Plataforma.Equals(modelo.Plataformas.First(p => p.Nombre.Equals("HBO Max")))).Select(p => new{
                Titulo = p.Titulo,
                Fecha = p.Titulo
                });
        Show(consulta2);
    ...
    static void Consulta3a()
    {
        ...
        var consulta3a = modelo.Plataformas.Where(plat => plat.Peliculas.Any(p => p.Duracion > 120));
        Show(consulta3a);
    }
    ...
    static void Consulta3b()
    {
        ...
        var consulta3b = modelo.Plataformas.Where(plat => plat.Peliculas.Count(p => p.Duracion > 120) > 1);
        Show(consulta3b);
    }
    ...
    static void Consulta4()
    {
        ...
        var consulta4 = modelo.Plataformas.Where(plat => !plat.Peliculas.Any(p => p.Generos.Contains("Fantasy")));
        Show(consulta4);
    }
    ...
    static void Consulta5()
    {
        ...
        var consulta5 = modelo.Valoraciones.Where(val => val.Fuente == "IMDb").Join(modelo.Peliculas.Where(p => p.Duracion > 120), valoracion => valoracion.IdImdb, pelicula => pelicula.IdImdb, (valoracion, pelicula) => new{
                Titulo = pelicula.Titulo,
                Puntuacion = valoracion.Puntuacion
    ...
    static void Consulta6()
    {
        ...
        var consulta6 = modelo.Plataformas.OrderBy(plat => plat.Peliculas.Select(p => p.Duracion)).FirstOrDefault()?? "-";
    }
